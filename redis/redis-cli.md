...
1. 查询某种类型的所有相关命令
   ...
   我们可以使用`help @<category>`来显示我们想要查询的种类的所有相关命令，redis提供以下种类：
...
上面我们介绍了如何使用redis-cli操作命令与服务器交互，接下来我们简单介绍一下redis-cli的一些特殊模式。redis-cli支持一些特殊的模式，这些模式都是通过可选项可实现的，它们可以完成以下功能：
